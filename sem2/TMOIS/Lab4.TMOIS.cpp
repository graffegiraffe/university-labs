...
int main() {
	...
	// Освобождение памяти для массива M
	for (int i = 0; i < 1; i++) { // 1 - размер массива M
		delete[] M[i];
	}
	delete[] M;

	// Освобождение памяти для массива P
	for (int i = 0; i < 1; i++) { // 1 - размер массива P
		delete[] P[i];
	}
	delete[] P;

	// Освобождение памяти для массива R1
	for (int i = 0; i < 1; i++) { // 1 - размер массива R1
		delete[] R1[i];
	}
	delete[] R1;

	// Освобождение памяти для массива R2
	for (int i = 0; i < 1; i++) { // 1 - размер массива R2
		delete[] R2[i];
	}
	delete[] R2;

	// Освобождение памяти для массива K1
	for (int i = 0; i < 10000; i++) {
		delete[] K1[i];
	}
	delete[] K1;

	// Освобождение памяти для массива K2
	for (int i = 0; i < 10000; i++) {
		delete[] K2[i];
	}
	delete[] K2;

	// Освобождение памяти для массива Dop_1
	for (int i = 0; i < 10000; i++) {
		delete[] Dop_1[i];
	}
	delete[] Dop_1;

	// Освобождение памяти для массива Dop_2
	for (int i = 0; i < 10000; i++) {
		delete[] Dop_2[i];
	}
	delete[] Dop_2;
