...
int main() {
	...
	//ОБЛАСТЬ ОТПРАВЛЕНИЯ УНИВЕРСУМА
	vector<int> Ux = {};
	for (int i = 1; i < 11; i++) {
		Ux.push_back(i);
	}

	//ОБЛАСТЬ ПРИБЫТИЯ УНИВЕРСУМА
	vector<int> Uy = {};
	for (int i = 1; i < 11; i++) {
		Uy.push_back(i);
	}
	...
	//ОБЛАСТЬ ОТПРАВЛЕНИЯ ДОПОЛНЕНИЯ
	cout << "\n\n-------ДОПОЛНЕНИЕ А-------\n       ОБЛАСТЬ ОТПРАВЛЕНИЯ\n";
	vector<int> OtpX = Ux;
	for (int i = 0; i < OtpX.size(); i++) {
		cout << OtpX[i] << " ";
	}

	//ОБЛАСТЬ ПРИБЫТИЯ ДОПОЛНЕНИЯ
	cout << "\n       ОБЛАСТЬ ПРИБЫТИЯ\n";
	vector<int> PrbY = Uy;
	for (int i = 0; i < PrbY.size(); i++) {
		cout << PrbY[i] << " ";
	}
