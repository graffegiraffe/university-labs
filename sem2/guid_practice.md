...
Но смотря на последний скриншот, мы видим что там появилось *примечание*. Его оформить можно используя команду **\scntext{примечание}{ваш текст}** ( в первой скобке можно писать примечание, пояснение и тд. Когда нужно пояснить что-то, опрделение, список и тд., используйте эту команду.
