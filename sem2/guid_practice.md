...
* section 0/1/2/3 - файлы, в которых вы будите писать все, они разбиты на секции (0,1,2,3....).
...
Переходим в **section2**. Кстати! *section0* и *section1* не трогаем, они должны остаться в отчете. Так вот, в **section2** нужно подключить сначала подключить библиотеки:
...
Благодаря командам **\scnheader {}** и **\scnidtf{}** мы смогли ввести наше понятие. Для каждого понятия будет такой вид, для кадой области, которую мы описываем будет использоваться **\scnheader {}**. Если у понятия есть несколько вариаций, их просто вот так "друг за другом" и пишем.
...
С помощью этих команад ( \begin{scnrelfromset}{}, \scnitem{} , \end{scnrelfromset}) в латехе мы можем дополнять наше определение, чем захотим. Например писать *недостатки этой системы* и перичеслять, *текущее состояниие* и перечислять, *рассматриваемые вопросы* и перичислять. Вообщем очень много "дополнений".
...
<img width="1009" alt="Снимок экрана 2024-05-27 в 00 01 13" src="https://github.com/graffegiraffe/kater/assets/145375460/9daef1ae-b83b-482e-9ad5-77abb4c4ef13">

Но читая статью, мы нашли там картинку по данной теме. Мы можем ее вставить. Используя команду **\scnhaselement{пример':}**(можно писать "иллюстрация" и тд.) и команду для описания этой картинки **\scnitem {тут ваше описание}** (можно без описаний). Получим такое:

<img width="677" alt="Снимок экрана 2024-05-27 в 00 05 54" src="https://github.com/graffegiraffe/kater/assets/145375460/b0b99095-ae36-4d2f-b8a3-c63e8ec5e2c5">

По такому же принципу мы можем сделать все классификации, представленные в моей литературе:

<img width="704" alt="Снимок экрана 2024-05-27 в 00 21 27" src="https://github.com/graffegiraffe/kater/assets/145375460/e92f3610-dd61-43c7-bde9-ebec30ec3862">


<img width="704" alt="Снимок экрана 2024-05-27 в 00 10 02" src="https://github.com/graffegiraffe/kater/assets/145375460/db1c90ff-a46c-433e-b2b3-22777810da79">

Но смотря на последний скриншот, мы видим что там появилось *примечание*. Его оформить можно используя команду **\scntext{пояснение}{ваш текст}** ( в первой скобке можно писать примечание, пояснение и тд. Когда нужно пояснить что-то, опрделение, список и тд., используйте эту команду.
